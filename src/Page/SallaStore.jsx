    ...
    return (
        <div>
            <ProjectPage
                ...
                projects={[{ img: '/public/assets/img/sallastore.png', name: "A Small Store", des: "HTML-css3", to: '' }, { img: '/public/assets/img/flora.png', name: "Discover places", des: "Html-css3", to: '/flora' }]}
